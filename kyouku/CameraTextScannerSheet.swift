...
private struct CameraTextScannerRepresentable: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> DataScannerViewController {
        ...
        do {
            ...
            CustomLogger.shared.pipeline(context: "OCR", stage: "Error", "startScanning failed domain=\(nsError.domain) code=\(nsError.code) message=\(nsError.localizedDescription)", level: .error)

...
extension TokenOverlayTextView {
    ...
    func resolveTokenSpacingBoundary(
        selection: FuriganaSpanSelection,
        length: Int,
        backing: NSString
    ) -> Int? {
    ...
    func pointHitsSemanticSpan(_ selection: FuriganaSpanSelection, at point: CGPoint) -> Bool {
    ...
    func pointHitsSemanticSpanForSpacing(_ selection: FuriganaSpanSelection, at point: CGPoint) -> Bool {
    ...
    func notifySpanSelection(_ selection: FuriganaSpanSelection?) {
    ...
    func makeContextMenu(for state: FuriganaContextMenuState, actionHandler: @escaping (FuriganaContextMenuAction) -> Void) -> UIMenu? {
    ...
    func spanSelectionContext(forUTF16Index index: Int) -> FuriganaSpanSelection? {
        ...
        return FuriganaSpanSelection(tokenIndex: tokenIndex, semanticSpan: span, highlightRange: spanRange)
    }
